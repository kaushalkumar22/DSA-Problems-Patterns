package dsa.graphs_topologicalsort;
...
public class CourseSchedule {
	...
	public static void main(String[] args) {
		...
		System.out.println(new CourseSchedule().canFinishDFS(5,prerequisites));
	}
	...
	private  boolean dfs(int course, Map<Integer, List<Integer>> adjMap,Set<Integer> visited) {
