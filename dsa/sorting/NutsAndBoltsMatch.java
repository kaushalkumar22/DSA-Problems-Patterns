package dsa.sorting;
/*
 *Matching nuts and bolts problem can be stated as follows: Ã¯Â¿Â½ Given a collection of n nuts of distinct sizes and n bolts 
 ...
 * 
 * Suppose we choose a nut and partition all bolts in {1Ã¢â‚¬Â¦n}, by comparing with this nut, into three intervals 
 * : {1Ã¢â‚¬Â¦i-1}, {i}, {i+1, n} such that each bolt in {1, i-1} is smaller, bolt i matches and each bolt in {i+1, n} 
 ...
 * interval {1Ã¢â‚¬Â¦n} into two smaller subproblems: finding matchings in the intervals {1Ã¢â‚¬Â¦i-1} and {i+1Ã¢â‚¬Â¦n}.
 * 
 * 
 * As we apply partitioning on nuts and bolts both so the total time complexity will be ÃŽËœ(2*nlogn) = ÃŽËœ(nlogn) on average.
 */
