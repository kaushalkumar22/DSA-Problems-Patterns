...
Otherwise, we return 0.
	...
	public static void main(String[] args) {
		List<Integer> nums = (List<Integer>) Arrays.asList(0,0,null,0,null,0,null,null,0);
		TreeNode root = TreeUtil.createTree(nums);
		System.out.println("Min Camera Require : " + minCameraCover(root));
	}
	static int res = 0;
	public static int minCameraCover(TreeNode root) {
		return (postorder(root) < 1 ? 1 : 0) + res;
	}
