 ...
 * values to update other cells. In this question, we represent the board using
 * a 2D array. In principle, the board is infinite, which would cause problems
 * when the active area encroaches the border of the array. How would you
