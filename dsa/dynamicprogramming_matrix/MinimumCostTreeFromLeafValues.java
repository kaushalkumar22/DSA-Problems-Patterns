 ...
 * Example 1:
 * 
 * Input: arr = [6,2,4] Output: 32 Explanation: There are two possible trees.
 ...
 * Constraints:
 * 
 * 2 <= arr.length <= 40 1 <= arr[i] <= 15 It is guaranteed that the answer fits
 * into a 32-bit signed integer (ie. it is less than 2^31).
 * 
 * @author IBM
 *
 */
