...
public class BestTimeToBuyAndSellStockIII {
	...
	public static int maxProfit2(int[] prices) {
		...
		int maxProfitT2 = 0;
		for (int price :prices){
			minPriceT1  =  Math.min(minPriceT1,price);
			maxProfitT1 =  Math.max(maxProfitT1,price-minPriceT1);
			minPriceT2  = Math.min(minPriceT2,price-maxProfitT1);
			maxProfitT2 = Math.max(maxProfitT2,price-minPriceT2);
		}
		return maxProfitT2;
	}
